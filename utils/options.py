...
def args_parser():
    ...
    parser.add_argument('--local_ep', type=int, default=6,
                        help="the number of local epochs: E, malicious clients")
    parser.add_argument('--local_ep_b', type=int, default=2,
                        help="the number of local epochs: E, benign clients")
 ...
 #************************atttack_label********************************#
    ...
    parser.add_argument('--loss', action='store_true', help='whether to record loss in training stage')
